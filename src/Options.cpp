...
bool Options::MERGED_FRAGMENTS_TO_BUILD = Constants::DEFAULT_MERGED_FRAGMENTS_TO_BUILD; // CTA: 6 / 2024
bool Options::LOOSE_ATOMTYPE_GENERATION = Constants::DEFAULT_LOOSE_ATOMTYPE_GENERATION; // CTA: 9 / 2024
bool Options::ALLOW_LINKER_LINKER_CONNECTIONS = Constants::ALLOW_LINKER_LINKER_CONNECTIONS; // CTA: 9 / 2024
